...
- **No mention of human review**, or broad rights for staff/contractors to read your content.
...
- **Stated, bounded retention** with a way to delete, and deletion that actually removes data from their systems.
- **Enterprise tier with a DPA** and tenant isolation for business customers.
- **Named sub-processors** listed publicly and kept up to date.
- **Data-residency options** (e.g. UK/EU processing).
- **Clear opt-outs** for training and history, easy to find in settings.
